...
const App = () => {
  ...
  const renderNavbar = () => (
    <nav className={`navbar sticky-navbar ${menuOpen ? "active" : ""}`}>
      <div>
        <img src="./img/logo.png" alt="Zhi Yi Ooi" className="logo" />
      </div>
      <button
      ...
      <div className={`navbar--items ${menuOpen ? "active" : ""}`}>
        <ul>
          <li>
            <button onClick={() => { setCurrentSection("classification"); closeMenu(); }} className="navbar--content">
              Classification
            </button>
          </li>
          <li>
            <button onClick={() => { setCurrentSection("history"); closeMenu(); }} className="navbar--content">
              History
            </button>
          </li>
        </ul>
